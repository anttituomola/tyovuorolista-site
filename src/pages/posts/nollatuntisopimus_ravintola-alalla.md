...
image:
    ...
    alt: 'Työntekijän muokkausnäkymä, jossa Työtunnit työsopimuksessa -kenttä.'
tags: ['TES', 'MaRa', 'nollatuntisopimus', 'vaihteleva työaika', 'sopimustunnit', 'ravintola-ala']
---
...
## MaRa-TES: vähimmäistyöaika sovitaan aina

MaRa-TES:ssä työnantaja ja osa-aikainen työntekijä sopivat joko

- **kiinteästä** kolmiviikkoisjakson vähimmäistyöajasta (esim.
  90 h / 3 vk), tai
...
kutsuttavat**: heihin vähimmäistyöaikamääräyksiä ei sovelleta, mutta
...
- Jos merkitty vuoro perutaan **myöhemmin kuin 48 tuntia ennen** sen
  alkua eikä palkkaa muuten makseta, työntekijälle on maksettava
  kohtuullinen korvaus peruuntumisen haitasta
...
<img src="/blogPostImages/tyotunnit-tyosopimuksessa/tyosuhde-tyotunnit.png" alt="Työntekijän muokkausnäkymä: Työtunnit työsopimuksessa -kenttä yksiköllä tuntia / 3 viikkoa" width="80%" style="max-width: 480px; display: block; margin: 20px auto;" />

Sen jälkeen [TES-tuki](/posts/tes_tuki_tyovuorosuunnittelussa) laskee
osa-aikaisen [lisätyön](/posts/lisatyo_ja_ylityo_ravintola-alalla) juuri
tästä rajasta, kalenteri näyttää suunnitellessa, paljonko
sopimustunteihin on matkaa, ja
[toteutuneiden tuntien seuranta](/posts/merkattujen_ja_puuttuvien_tyotuntien_laskeminen)
antaa suoraan aineiston TES:n edellyttämään puolivuosittaiseen
tarkasteluun: näet jaksokohtaisesti, ylittyykö sovittu minimi
säännöllisesti.

---

*Lähteet: [Työsopimuslaki 55/2001, 1 luku 11 § (Finlex)](https://www.finlex.fi/fi/lainsaadanto/2001/55), [Työaikalaki 872/2019, 30 ja 30 a § (Finlex)](https://www.finlex.fi/fi/lainsaadanto/2019/872), [MaRa-TES, työaika (tes.mara.fi)](https://tes.mara.fi/matkailu-ravintola-ja-vapaa-ajan-palveluita-koskeva-tyontekijoiden-tyoehtosopimus/tyoaika.html), [Työsuojeluhallinto: vaihteleva työaika](https://tyosuojelu.fi/tyosuhde/tyoaika/vaihteleva), [PAM: nollatuntisopimukset](https://www.pam.fi/en/working-life/guide-to-working-life/employment-relationships/employment-contracts/zero-hour-contracts/)*
