...
image:
    url: '/blogPostImages/kipa-tes/kipa-varoitukset-kalenterissa.png'
    alt: 'Kalenterinäkymä, jossa TES-varoituksia tasoittumisjakson työvuoroista.'
tags: ['TES', 'kiinteistöpalveluala', 'tasoittumisjärjestelmä', 'työaika', 'ylityö']
---

**Lyhyesti:** KipaTES:n keskimääräisessä viikkotyöajassa
(tasoittumisjärjestelmä) säännöllinen työaika tasoittuu 37,5 tuntiin
viikossa enintään **8 viikon jaksossa** (TES 8 § 1). Ylityölaskenta
poikkeaa täysin tavallisesta viikkotyöstä: **yli 10 tunnin päivät ovat
suoraan +100 %:n ylityötä**, ja loput korotukset tilitetään vasta
jakson lopussa kaavalla, jossa +50 %:n katto on **viikot × 10,5
tuntia**. Vuoden 2027 alusta jakso pitenee 12 viikkoon ja listalle
tulee 9 peräkkäisen työpäivän katto.
...
Tasoittumisjaksolla yksittäinen työpäivä voi olla enintään **9 tuntia**
ja yksittäinen viikko enintään **45 tuntia** ilman työntekijän
...
| Viikko | max 45 h (ilman suostumusta) | max 50 h |

Osa-aikaisen jakson katto lasketaan sovituista viikkotunneista:
sopimuksen omassa esimerkissä 25 h/vk -työntekijän neljän viikon
jaksokatto on 100 tuntia, eikä sen täyttyminen tuota lisä- tai
ylityötä.

## Ylityömekaniikka on eri kuin viikkotyössä
...
| Erittely | Tunnit | Korvaus |
| --- | --- | --- |
| Yli 10 h/päivä | 3 h | +100 % |
| Jakson perusosa (4 × 37,5) | 150 h | normaali palkka |
| +50 %:n katto (4 × 10,5) | 42 h | +50 % |
| Ylijäämä (197 − 3 − 150 − 42) | 2 h | +100 % |

## 1.1.2027: jakso pitenee ja työpäiväputkelle katto

Allekirjoituspöytäkirja tuo vuoden 2027 alusta kaksi muutosta:
tasoittumisjakson enimmäispituus nousee **8:sta 12 viikkoon**, ja
