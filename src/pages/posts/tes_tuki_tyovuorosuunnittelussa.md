...
image:
    ...
    alt: 'Työvuorokalenteri, jossa TES-varoitusmerkki ja lakivaroituksen sisältävä työvuoro.'
tags: ['TES', 'työehtosopimus', 'MaRa', 'työaikalaki', 'uudet ominaisuudet', 'päivitykset']
---
...
<img src="/blogPostImages/tes-tuki/tes-varoitus-kalenterissa.png" alt="Kalenterinäkymä, jossa punaisella reunustettu vuoro ja 1 laki -varoitusmerkki" width="100%" style="max-width: 900px; display: block; margin: 20px auto;" />

Kalenterin oikean yläkulman merkki kokoaa listan huomautukset. Klikkaamalla
sitä avautuu paneeli, joka kertoo työntekijäkohtaisesti mistä on kyse ja
minä päivänä:

<img src="/blogPostImages/tes-tuki/tes-huomautukset-paneeli.png" alt="TES-huomautukset-paneeli, jossa työaikalakivaroitus vuorokausilevosta" width="100%" style="max-width: 900px; display: block; margin: 20px auto;" />
...
## Tunnit valmiiksi luokiteltuina palkanlaskentaan

Tuntien kirjaus -sivulle on tullut jaksojen pikavalinta: yhdellä
klikkauksella saat tarkasteluun täsmälleen yhden kolmiviikkoisjakson, ja
sovellus laskee TES:n mukaiset kategoriat automaattisesti:
...
nämä valmiiksi, samoin V- ja X-päivinä tehdyn työn korotukset sekä
