...
image:
    ...
    alt: 'Työehtosopimusasetukset, joissa tasoittumisjärjestelmän kytkin, kauden pituus ja alkujakso.'
...
Normaalisti jokaisen kolmiviikkoisjakson säännöllinen työaika on enintään
112,5 tuntia, ja kaikki sen ylittävä on
[lisä- tai ylityötä](/posts/lisatyo_ja_ylityo_ravintola-alalla). Monella
ravintola- ja matkailualan työpaikalla kysyntä ei jakaudu tasan: kesäterassi,
hiihtokeskuksen sesonki tai tapahtumaviikonloput synnyttävät piikkejä, joita
seuraa hiljaisempi jakso. Ilman tasoittumista jokainen piikki tuottaa
korotettua palkkaa, vaikka kokonaistuntimäärä pysyisi vuositasolla
kohtuullisena.
...
TES 30 §:n mukaisella paikallisella sopimuksella tasoittumiskautta voidaan
...
Kauden ylimääräiset tunnit tasoitetaan joko lyhentämällä päivittäistä
työaikaa tai antamalla erillisiä
...
- merkitään työvuorolistaan omana merkintänään
...
Tasoittumisjaksolla korotettua palkkaa maksetaan vasta jaksokaton (130 h,
laajennetussa mallissa 136 h) ylittävistä tunneista:

| Ylittävät tunnit (130 h katon jälkeen) | Korvaus |
| --- | --- |
| 7,5 tuntia | lisätyö, yksinkertainen tuntipalkka |
| seuraavat 18 tuntia | ylityö +50 % |
| loput tunnit | ylityö +100 % |
...
## Kauden lopun tasaus: ylijäämä ja alijäämä

Kun tasoittumiskausi päättyy, lasketaan koko kauden tuntien summa (jaksokohtaiset
ylityötunnit pois lukien) kauden enimmäistyöaikaa vasten:

- **Ylijäämä** (kauden summa ylittää enimmäismäärän) korvataan samalla
  portaikolla kuin jakson sisällä: 7,5 tuntia lisätyönä, seuraavat 18 tuntia
  +50 %, loput +100 %.
...
on käytettävissä 50 tuntia viimeisellä jaksolla. Jos hän tekeekin 81 tuntia,
ylitys on 31 tuntia: 7,5 tuntia lisätyötä, 18 tuntia +50 % ja loput 5,5 tuntia
+100 % korotettuna.

## Työsuhteen päättyminen kesken tasoittumiskauden

Jos työsuhde päättyy kesken kauden, syyllä on väliä:

- **Työntekijästä johtuva syy** (esim. irtisanoutuminen): alijäämä voidaan
  vähentää palkasta, ylijäämä korvataan rahana yksinkertaisella
  tuntipalkalla.
...
## Työntekijälle: mitä kannattaa tietää
...
Kun tasoittuminen on päällä, sovellus:

- laskee jokaisen kokoaikaisen työntekijän jaksokohtaisen ja kumulatiivisen
  saldon automaattisesti, sitä mukaa kun suunnittelet listoja
- varoittaa, kun yksittäinen jakso ylittää 130 (tai sovitun 136) tunnin
  katon, ja erikseen, kun kauden kokonaistunnit ylittävät kauden
  enimmäismäärän
- muistuttaa, jos kaudelle ei ole merkitty vielä kolmea tasoitusvapaata,
...
*Lähteet: [MaRa-TES, työaika, 12 § (tes.mara.fi)](https://tes.mara.fi/matkailu-ravintola-ja-vapaa-ajan-palveluita-koskeva-tyontekijoiden-tyoehtosopimus/tyoaika.html), [PAM: Matkailu- ja ravintola-alan TES, työntekijät (PDF)](https://www.pam.fi/wp-content/uploads/2023/06/TAITTO_TES_Marava_2025.pdf), [Työaikalaki 872/2019 (Finlex)](https://www.finlex.fi/fi/laki/ajantasa/2019/20190872)*
