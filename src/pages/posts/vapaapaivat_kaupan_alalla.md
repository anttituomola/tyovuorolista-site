...
image:
    url: '/blogPostImages/kaupan-tes/kaupan-varoitukset-kalenterissa.png'
    alt: 'Työvuorokalenteri, jossa TES-varoitusmerkki vuorolla ja varoituslaskuri 2 laki, 3 TES.'
tags: ['TES', 'kaupan ala', 'vapaapäivät', 'sunnuntaivapaa', 'aattovapaa']
---

**Lyhyesti:** Kaupan TES:n 8 § määrää vapaapäivistä neljä sääntöä,
jotka jokaisen listantekijän on hyvä osata: **vapaiden välissä enintään
8 työvuoroa**, kalenterivuodessa vähintään **22 työstä vapaata
sunnuntaita**, vuodessa **7 pitkää viikonloppuvapaata ja 8 muuta
vähintään 59 tunnin yhtenäistä vapaata**, ja neljästä aatosta
...
## 22 työstä vapaata sunnuntaita vuodessa

Työntekijällä on kalenterivuoden aikana vähintään **22 työstä vapaata
sunnuntaita**, ellei toisin sovita (8 § 28). Jos työsuhde ei kestä koko
vuotta, vapaat sunnuntait suhteutetaan. Sääntö ei koske huolto- ja
liikenneasematyöntekijöitä eikä kioskimyyjiä.

Tämä on tyypillinen "huomataan marraskuussa" -sääntö: yksittäinen
...
Perustellusta syystä (esim. säännöllinen vuorokierto) säännöstä voi
poiketa, ja antamisesta voi sopia työpaikkakohtaisesti toisin.

## Aattovapaat: kaksi neljästä

Vakituisella työntekijällä pitää olla vapaana **2 näistä neljästä**:
pääsiäislauantai, juhannusaatto, jouluaatto ja uudenvuodenaatto
(8 § 29). Toimihenkilöillä vapaita ovat lähtökohtaisesti
pääsiäislauantai, juhannusaatto ja jouluaatto.

Kaksi käytännön huojennusta: vuosilomalle osuvat aatot lasketaan
saaduiksi aattovapaiksi, ja työnantaja voi korvata aattovapaat
maksamalla kyseisinä päivinä tehdystä säännöllisestä työstä **100 %:lla
korotetun palkan** (8 § 31).

## Yövuoroista

Yötyön puolelta samaan suunnittelupakettiin kuuluu, että yövuoroja
(vähintään 1,5 h klo 23–06 välillä) saa teettää enintään **5
peräkkäin**, ja vähintään viiden peräkkäisen yövuoron jälkeen on
annettava **2 vapaata** (9 §).
...
*Lähteet: [Kaupan työehtosopimus 1.2.2025–31.1.2028 (PAM)](https://www.pam.fi/wp-content/uploads/2023/03/Kaupan_TES_korjattu15092025_PAM.pdf) 8 § 26–29 ja 31, 9 §; [Työaikalaki 872/2019 (Finlex)](https://www.finlex.fi/fi/laki/ajantasa/2019/20190872) 27 § (viikkolepo).*
