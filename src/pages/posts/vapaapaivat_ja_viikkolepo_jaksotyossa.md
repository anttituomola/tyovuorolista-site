...
image:
    url: '/blogPostImages/sostes-tes/sostes-varoitukset-kalenterissa.png'
    alt: 'Kalenterinäkymä: TES-varoitukset yövuoroputkesta ja lepoajoista.'
tags: ['TES', 'sosiaalipalveluala', 'jaksotyö', 'vapaapäivät', 'viikkolepo', 'työhyvinvointi']
---
...
työvuorolistalla tulee olla vähintään kuusi vapaapäivää** sekä
[arkipyhävapaat](/posts/sostes_tyovuorosuunnittelussa) arkipyhäjaksoilla,
...
Työntekijälle on järjestettävä **vähintään kaksi lauantain ja sunnuntain
...
Vuorokausilepo on **11 tuntia** jokaisen työvuoron alkamista seuraavan
24 tunnin aikana; jaksotyössä sen saa työn järjestelyihin liittyvistä
syistä lyhentää **9 tuntiin** (työaikalaki 25 §). Lyhennetty lepo on
korvattava seuraavan vuorokausilevon yhteydessä, viimeistään 14
vuorokauden kuluessa. Paikallisesti sopien lepo voidaan lyhentää 9
tuntiin laajemminkin (TES 6 a §).

Yövuoroja saa teettää työvuoroluettelon mukaan peräkkäin **enintään
viisi**, minkä jälkeen on annettava vähintään **24 tunnin yhtenäinen
vapaa**. Kaksi ylimääräistä yövuoroa on mahdollista vain työntekijän
kutakin kertaa varten antamalla suostumuksella (TES 6 § 9).
