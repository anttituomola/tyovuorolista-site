...
tags: ["vertailu", "hinnoittelu", "työvuorosuunnittelu", "ohjelmistot", "TES"]
---

Etsitkö työvuorosuunnitteluohjelmaa pienelle tai keskikokoiselle yritykselle? Tässä vertailussa käydään läpi Suomessa tarjolla olevat vaihtoehdot: mitä ne maksavat, kuka julkaisee hintansa, mistä saa ilmaisen kokeilun ja mikä ohjelma tulkitsee työehtosopimuksia.

**Avoimuuden vuoksi heti alkuun:** tämän vertailun on kirjoittanut Tyovuorolista.fi:n tekijä. Olemme yksi vertailun ohjelmista. Siksi vertailu on tehty näin:
...
| **Finago Työvuorovelho** | ❌ | Tarjouksen kautta | Demo pyynnöstä | ❌ | ✅ (myyntivetoinen käyttöönotto) |
| **Finago MaraPlan Pro** | ❌ | Tarjouksen kautta | Demo pyynnöstä | ❌ | ✅ MaRa-painotus |
...
Laskettu julkisista hinnastoista (alv 0 %, kuukausilaskutus). Myyntivetoiset järjestelmät puuttuvat, koska hintaa ei julkaista.

**10 työntekijän ravintola tai myymälä:**

| Ohjelma | Kuukausihinta | Laskukaava |
| :-- | :-: | :-- |
| **Tyovuorolista.fi Normi** | **18 €** (vuosilaskutuksella 12 €/kk) | kiinteä tilihinta |
| Otta Mini | 29 € | 9 € + 10 × 2 € |
| Tuntikone+ ja vuorosuunnittelulisä | 40 € | 10 × (3 € + 1 €) |
| Workfeed Basic | 40 € | 10 × 4 € |

**20 työntekijän yritys:**

| Ohjelma | Kuukausihinta |
| :-- | :-: |
| **Tyovuorolista.fi Normi** | **18 €** (vuosilaskutuksella 12 €/kk) |
| Otta Mini | 49 € |
...
Kotimainen työajanseurannan ohjelmisto, jossa myös työvuorosuunnittelu. Julkinen hinnasto: Mini 9 €/kk + 2 €/käyttäjä, Pro 49 €/kk + 8 €/käyttäjä, 14 päivän ilmainen kokeilu. Hyvä valinta, jos tärkein tarpeesi on **kellokortti ja työaikojen leimaus** ja vuorosuunnittelu tulee siinä sivussa.
...
HRSuunti on kotimainen, erityisesti ravintola-, hoiva- ja apteekkialalle suunnattu järjestelmä; Nepton tunnetaan työajanseurannasta ja HR-kokonaisuudesta. Molemmat ovat myyntivetoisia eivätkä julkaise hinnastoa (tarkistettu 3.8.2026). Sopivat kasvaville organisaatioille, jotka haluavat kokonaisjärjestelmän ja ohjatun käyttöönoton.
...
**Mitä työvuorosuunnitteluohjelma maksaa?**
