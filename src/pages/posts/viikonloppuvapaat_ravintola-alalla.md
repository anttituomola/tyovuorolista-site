...
image:
    ...
    alt: 'tyovuorolista.fi:n kalenterinäkymä, jossa X- ja V-päivät merkittynä.'
tags: ['TES', 'MaRa', 'viikonloppuvapaa', 'vapaapäivät', 'V-päivä', 'X-päivä', 'ravintola-ala']
---
...
Jokaista viittä työpäivää sisältävää viikkoa kohden työntekijä
ansaitsee kaksi vapaapäivää:
[V-päivän](/posts/mita_tarkoittaa_v-paiva_tyovuorolistassa) (vähintään
30 tuntia, annettava ansaintaviikolla) ja
[X-päivän](/posts/mita_tarkoittaa_x-paiva_tyovuorolistassa) (vähintään
24 tuntia, joustavampi sijoittelu saman
...
MaRa-TES 8 §:n mukaan vähintään joka viides viikonloppu tulee
järjestää vapaaksi siten, että **perjantai ja lauantai tai lauantai ja
sunnuntai annetaan peräkkäisinä vapaapäivinä**. Työpaikkakohtaisesti
voidaan sopia myös sunnuntai–maanantai-yhdistelmästä. Säännöstä voidaan
poiketa vain työntekijän omasta halusta tai pakottavasta syystä.
...
## Saako pyhävuorot jakaa miten vain?
...
työsuojelulliset syyt. Ja jouluaatosta vielä erikseen: työntekijällä
on pyynnöstä oikeus saada jouluaaton iltavuoro ja joulupäivä vapaaksi,
kun pyyntö esitetään viikkoa ennen joululistan laatimista (hotellit ja
eräät muut poikkeukset pois lukien).

## TES-apuri vahtii viikonloppuja puolestasi
...
Kiertävän vapaapäiväjärjestelmän rakentaminen on listantekijän omissa
käsissä, mutta [X- ja V-päivien merkkaus](/posts/x_ja_v-paivien_merkkaus_tyovuorolistaan)
ja [toistuvat vuorot](/posts/toistuvat_tyovuorot) tekevät kierrosta
helpon ylläpitää.

---

*Lähteet: [MaRa-TES, työaika 8–10 § (tes.mara.fi)](https://tes.mara.fi/matkailu-ravintola-ja-vapaa-ajan-palveluita-koskeva-tyontekijoiden-tyoehtosopimus/tyoaika.html), [Työaikalaki 872/2019, 17 ja 27 § (Finlex)](https://www.finlex.fi/fi/laki/ajantasa/2019/20190872), [Työsopimuslaki 55/2001, 2 luku 2 § (Finlex)](https://www.finlex.fi/fi/laki/ajantasa/2001/20010055), [PAM: työvuorolistat MaRa-alalla](https://www.pam.fi/en/wiki/rosters-in-hotel-restaurant-and-leisure-services.html)*
