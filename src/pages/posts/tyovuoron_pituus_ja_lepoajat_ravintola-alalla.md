...
tags: ['TES', 'MaRa', 'työvuoro', 'lepoajat', 'tauot', 'työaikalaki', 'ravintola-ala']
---
...
tuntia**. Yli kuuden tunnin työpäivään kuuluu lisäksi **vähintään 30
minuutin ruokatauko** tai tilaisuus aterioida työn lomassa.
...
kysynnästä johtuvaan työvoiman tarpeen määrään, liikkeen aukiolo- ja
palveluaikaan tai työn lyhytkestoisuuteen. Käytännössä tämä kattaa
tilanteet, joissa ruuhka ajoittuu kapealle aikaikkunalle tai työ on
luonteeltaan lyhytkestoista.
...
**Lyhyesti:** Yksittäinen työvuoro saa olla **enintään 10 tuntia**.
Työntekijän suostumuksella vuoroa voidaan pidentää, mutta vuorokauden
työaika ei saa missään tapauksessa ylittää **16 tuntia**.

MaRa-TES:n tarkat määräykset:
...
suostumuksen. Vuorokausirajaan (16 h) jää vielä neljä tuntia pelivaraa,
mutta vuorokausilepo asettaa omat rajoituksensa seuraavan vuoron
alkamiselle.

## Vuorokausilepo: 11 tuntia, sopimalla vähintään 8

**Lyhyesti:** Työvuorojen väliin jää **vähintään 11 tunnin lepoaika**,
ellei työntekijän kanssa toisin sovita. Sovittaessakin lepoajan on
oltava **vähintään 8 tuntia**. Peräkkäisinä päivinä teetettyjen
vähintään 10 tunnin vuorojen väliin on kuitenkin aina jätettävä
**vähintään 11 tuntia**.
...
7-tuntinen. Jos työntekijän kanssa on sovittu alle 11 tunnin lepoajasta,
huominen vuoro voi alkaa aikaisintaan klo 10 (8 tunnin lepoaika). Ilman
sopimusta aikaisin aloitus on klo 13 (11 tunnin lepoaika).
...
**Lyhyesti:** **Yli 4 tunnin** vuoroon kuuluu palkallinen kahvitauko.
Kun yhdenjaksoinen työaika ylittää **6 tuntia**, työntekijälle on
annettava **vähintään 30 minuutin lepoaika** tai tilaisuus aterioida
työn lomassa. Lepoaika on palkaton vain, jos työntekijä saa sen aikana
vapaasti poistua työpaikalta.
...
TES:n määräykset kokonaisuudessaan:

- **Kahvitauko:** vuoron pituuden ollessa yli 4 tuntia annetaan
  vähintään yksi kahvitauko. Tauko luetaan työajaksi, eikä sen aikana
  saa poistua työpaikalta ilman työnantajan lupaa. Jos taukoa ei töiden
  järjestelyjen takia voida antaa (lähinnä yksintyöskentelyssä),
...
- **Yli 10 tunnin vuorot:** työntekijällä on kahdeksan tunnin
  työskentelyn jälkeen halutessaan oikeus enintään puolen tunnin
  lisätaukoon työnantajan määräämänä ajankohtana.
- **Palkallinen vai palkaton:** lepoaikaa ei lasketa työajaksi vain,
  jos työntekijä saa sen aikana vapaasti poistua työpaikalta. Jos
  paikalla pitää olla tai olla käytettävissä, tauko on työaikaa ja siitä
  maksetaan palkka. Lepoaikaa ei myöskään saa sijoittaa välittömästi
  työvuoron alkuun tai loppuun.

**Esimerkki:** Kahdeksan tunnin vuorossa (klo 10–18) työntekijä syö
...
Liittyviä ohjeita:
[kolmiviikkoisjakso ja sen tuntirajat](/posts/kolmiviikkoisjakso_ravintola-alalla),
[lisätyö ja ylityö ravintola-alalla](/posts/lisatyo_ja_ylityo_ravintola-alalla)
sekä [vuorojen oletuspituuden
asettaminen](/posts/vuorojen_oletuspituus_ja_aikaportaat).

---

*Lähteet: [MaRa-TES, työaika: työvuoron pituus, lepoajat ja kahvitauko (tes.mara.fi)](https://tes.mara.fi/matkailu-ravintola-ja-vapaa-ajan-palveluita-koskeva-tyontekijoiden-tyoehtosopimus/tyoaika.html), [Työaikalaki 872/2019, 24 § päivittäiset tauot ja 25 § vuorokausilepo (Finlex)](https://www.finlex.fi/fi/laki/ajantasa/2019/20190872)*
