...
export const featureImages: Record<string, string> = {
  ...
  'sijaisen-haku': '/blogPostImages/sijaisen-haku/peittovuoro-kalenteri.png',
...
export const resources: ResourceItem[] = [
  ...
  },
  {
    ...
    section: 'reference',
    type: 'reference',
    blogSlug: '/posts/tyovuoron_pituus_ja_lepoajat_ravintola-alalla',
  },
  {
...
export const resourceImages: Record<string, string> = {
  ...
  'shift-length-and-rest': '/blogPostImages/tyovuoron_minimipituus_4h-min.png',
...
export const featureIcons: Record<string, string> = {
  ...
  'sijaisen-haku': 'ic:baseline-group-add',
